...
const MAX_PAGES_PER_DOMAIN: usize = 10000; // Set your desired max pages per domain here
...
fn should_exclude_domain(url: &str) -> bool {
    ...
    const EXCLUDED_DOMAINS: [&str; 9] = ["facebook", "youtube", "linkedin", "instagram", "flickr", "bloomberg", "pintrest", "amazonaws", "youtu.be"];
