                            ...
                            Ok(res) => {
                                ...
                                let mut new_urls = Vec::new();
                                {
                                    ...
                                    for element in fragment.select(&selector) {
                                        ...
                                        if !should_exclude_domain(new_url) && (new_url.starts_with("http") || new_url.starts_with("https")) {
...
fn should_exclude_domain(url: &str) -> bool {
    ...
    const EXCLUDED_DOMAINS: [&str; 5] = ["facebook", "youtube", "linkedin", "instagram", "flickr"];
